 ...
 * @see de.kupzog.ktable.t4eclipse.KTableModel
 * @see de.kupzog.ktable.t4eclipse.KTableDefaultModel
 * @see de.kupzog.ktable.t4eclipse.KTableSortedModel
 * @see de.kupzog.ktable.t4eclipse.KTableCellRenderer
 * @see de.kupzog.ktable.t4eclipse.KTableCellEditor
 * @see de.kupzog.ktable.t4eclipse.KTableCellSelectionListener
 *  
 */
...
//        cell.y+=m_TopRow;
        ...
        if (column >= 0 && column < m_Model.getColumnCount()) {
            ...
            for (int i = 0; i < m_Model.getFixedHeaderRowCount(); i++) {
                int width = m_Model.getCellRenderer(column, i).getOptimalWidth(
                        gc, column, i, m_Model.getContentAt(column, i), true, m_Model);
                if (width > optWidth)
                    optWidth = width;
            }
    ...
    protected void fireCellDoubleClicked(int col, int row, int statemask) {
        for (int i = 0; i < cellDoubleClickListeners.size(); i++) {
            ((KTableCellDoubleClickListener) cellDoubleClickListeners.get(i))
                    .cellDoubleClicked(col, row, statemask);
        }
    }
    ...
    protected void fireFixedCellDoubleClicked(int col, int row, int statemask) {
        for (int i = 0; i < cellDoubleClickListeners.size(); i++) {
            ((KTableCellDoubleClickListener) cellDoubleClickListeners.get(i))
                    .fixedCellDoubleClicked(col, row, statemask);
        }
    }
     ...
     * @see de.kupzog.ktable.t4eclipse.KTableModel for more information.
