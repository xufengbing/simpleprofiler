...
/**
 * An abstract base implementation for a cell editor that opens a 
 * dialog.<p>
 * Implement the methods <code>getDialog()</code> and 
 * <code>setupShellProperties()</code> as needed.
...
public abstract class TableCellEditorDialog extends KTableCellEditor {
	...
	/**
	 * Changes the properties of the dialog shell. One could be 
	 * the bounds of the dialog...<p>
	 * Overwrite to change the properties.
	 * @param dialogShell The shell of the dialog.
	 */
