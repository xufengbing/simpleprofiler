 ...
 *     Jean-Michel Lemieux - enhancements to traverse into subtrees that
 *         exist in only one side of the comparison.
 *******************************************************************************/
...
/*
 * NOTE:
 * Copied from the org.eclipse.compare plug-in and modified for the RCP book. Modifications
 * were made to allow the differences appear for directories (deeply) that don't 
 * exist in on of the sources of the diff.
 */
