...
public class View extends ViewPart implements ISelectionListener {
	...
	private Action markSpamAndMoveAction;
	...
	private void initializeToolBar() {
		getViewSite().getActionBars().getToolBarManager().add(markSpamAndMoveAction);
	}

	private void createActions() {

		markSpamAndMoveAction = new Action("Mark spam and move") {
			public void run() {
		...
		markSpamAndMoveAction.setImageDescriptor(Activator.getImageDescriptor("icons/sample.gif"));
		markSpamAndMoveAction.setToolTipText("Mark spam and move");
	}
	private void initializeMenu() {
		getViewSite().getActionBars().getMenuManager().add(markSpamAndMoveAction);
	}
	@Override
	public void dispose() {
