...
public class CreateServerPage extends WizardPage {
	...
	public void loadFromServer() {
		...
		hostnameText.setText(server.getHostname());
	...
	public void updateServer() {
		server.setHostname(hostnameText.getText());
		server.setUsername(usernameText.getText());
		server.setPassword(passwordText.getText());
		try {
