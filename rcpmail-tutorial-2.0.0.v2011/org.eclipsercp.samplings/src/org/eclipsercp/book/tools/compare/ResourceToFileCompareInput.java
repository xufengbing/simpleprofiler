...
private final Integer chap2;
  ...
  /*
	 ...
	 */
  public ResourceToFileCompareInput(Integer chap1, Integer chap2, CompareConfiguration config) {
    super(config);
	this.chap1 = chap1;
	this.chap2 = chap2;
  ...
  public String getTitle() {
	return "Chapter " + chap1 + " - Chapter " + chap2;
  }
  ...
  public void setSelection(IResource project, File file) {
   ...
   // IResource[] selection= Utilities.getResources(s);
    ...
    fRight= new FileNode(fRightResource);
    fAncestor= new FileNode(fAncestorResource);
  }
  ...
  void initializeCompareConfiguration() {
		...
		cc.setLeftLabel("Chapter " + chap1 + " (in workspace)");
		cc.setRightEditable(false);
		cc.setRightLabel("Chapter " + chap2 + " (in file system)");
	}
