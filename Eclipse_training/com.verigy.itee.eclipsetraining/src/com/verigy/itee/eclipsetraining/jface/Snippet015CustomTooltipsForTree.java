...
package com.verigy.itee.eclipsetraining.jface;
...
public class Snippet015CustomTooltipsForTree {
	...
	public static void main(String[] args) {
		...
		CellLabelProvider labelProvider = new CellLabelProvider() {
			 ...
			 * 
			 * @see
			 * org.eclipse.jface.viewers.ViewerLabelProvider#getTooltipText(
			 * java.lang.Object)
			 */
			 ...
			 * 
			 * @see
			 * org.eclipse.jface.viewers.ViewerLabelProvider#getTooltipShift
			 * (java.lang.Object)
			 */
			 ...
			 * (non-Javadoc)
			 * 
			 * @seeorg.eclipse.jface.viewers.ViewerLabelProvider#
			 * getTooltipDisplayDelayTime(java.lang.Object)
			 */
			...
			public void update(ViewerCell cell) {
				...
				cell.setImage(display.getSystemImage(SWT.ICON_WARNING));
